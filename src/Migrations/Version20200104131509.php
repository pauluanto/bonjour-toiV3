 ...
 */
final class Version20200104131509 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE modele ADD marque_id INT DEFAULT NULL, ADD libelle VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE modele DROP marque_id, DROP libelle');
    }
}
